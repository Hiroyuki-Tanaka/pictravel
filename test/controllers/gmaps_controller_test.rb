...
class GmapsControllerTest < ActionController::TestCase
  ...
  test "should create gmap" do
    assert_difference('Gmap.count') do
      post :create, gmap: { address: @gmap.address, description: @gmap.description, latitude: @gmap.latitude, longitude: @gmap.longitude, title: @gmap.title }
    end
  ...
  test "should update gmap" do
    patch :update, id: @gmap, gmap: { address: @gmap.address, description: @gmap.description, latitude: @gmap.latitude, longitude: @gmap.longitude, title: @gmap.title }
    assert_redirected_to gmap_path(assigns(:gmap))
  end
